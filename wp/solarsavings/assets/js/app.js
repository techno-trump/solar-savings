(() => {
    ...
    const stepsMapping = [ "avaragePowerBill", "address", "homeType", "roofShade", "creditScore", "contact", "email", "phoneNumber", "booking", "thankYou" ];
    ...
    function createContact(data, identifier, state) {
        ...
        return fetch("https://calculatemysolarsavings.com/wp-json/ghl-hooks/v1/contacts/", {
            method: "POST",
            headers: {
